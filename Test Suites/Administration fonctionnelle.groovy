 ...
 */
/*def setBannette () {
	return  GlobalVariable.Bannette = "E2E_Bannette_AdmnistrationF"
}*/
def setDossier () {
	return GlobalVariable.Dossier =  "E2E_Dossier_AdmnistrationF"
}
...
def tearDownTestCase() {
	...
	println "retourner à la page vue documentaire"
