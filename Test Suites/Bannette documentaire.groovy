 ...
 */
/*def setBannette () {
	return  GlobalVariable.Bannette = "E2E_Bannette_Documentaire"
}*/
def setDossier () {
	return GlobalVariable.Dossier = "E2E_Dossier_Documentaire"
}
...
def tearDownTestCase() {
	...
	//CustomKeywords.'utils.Bannettes.ClickTitreBannetteVueDocumentaire'(setBannette())
}
