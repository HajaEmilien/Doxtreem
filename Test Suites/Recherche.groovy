 ...
 */
/*def setBannette () {
	return GlobalVariable.Bannette = "E2E_Bannette_Recherche"
}*/
def setDossier () {
	return GlobalVariable.Dossier ="E2E_Dossier_Recherche"
}
...
def tearDownTestCase() {
	...
	//println "retourner à la page vue documentaire puis accéder dans la bannette : "+setBannette ()+" à la fin des tests"
