...
def setupTestCase() {
	if (WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Page_Centre_de_traitement'))) {
            WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Page_Centre_de_traitement'))
