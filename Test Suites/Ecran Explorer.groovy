...
/*def setBannette () {
	return  GlobalVariable.Bannette = "E2E_Bannette_EcranExplorer"
}*/
def setDossier () {
	return GlobalVariable.Dossier = "E2E_Dossier_EcranExplorer"
}
...
def setUp() {
	...
	//WebUI.callTestCase(findTestCase('Tools/Creer un utilisateur'), ['user':"E2E_User"], FailureHandling.OPTIONAL)
	CustomKeywords.'utils.Bannettes.AjoutDossierDansBannette'(setDossier(),GlobalVariable.Bannette)
	setDossier()
	WebUI.callTestCase(findTestCase('Tools/Creer un document'), ['nomdoc':'E2E_Document_PDC'], FailureHandling.OPTIONAL)
