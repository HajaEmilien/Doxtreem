...
WebUI.callTestCase(findTestCase('Tools/Televerser un document'), [:], FailureHandling.OPTIONAL)
...
if (txt.size()>0) {
	...
	assertTrue(WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Centre de distribution/ico_information')))
