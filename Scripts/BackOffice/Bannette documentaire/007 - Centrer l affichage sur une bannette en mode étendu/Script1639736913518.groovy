...
for (int i = 1; ; i++) {
	 ...
	 aydy = WebUI.getAttribute(findTestObject('Object Repository/Page_Doxtreem - Explorateur/Bannette_cible', ["index":i]), 'aria-label', FailureHandling.STOP_ON_FAILURE)
		...
		if (aydy == "GED") {
			...
			/************************************Trouver le bouton Passer en mode étandu puis pound***********************************/
			...
			pound = "//*[@id=\"" + entet + "\"]/section[1]/section[3]/section/button/md-icon"
			...
			WebUI.delay(3)
			WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Explorateur/ettendu_button', [('index'): pound]), FailureHandling.STOP_ON_FAILURE)
			break
			}
		}
	}
