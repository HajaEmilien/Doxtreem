...
for (int i = 1; ; i++) {
	...
	WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/ListItem', [('index'): i]), 5)
	...
	if (Text.contains("(0)") == false) {
		...
		WebUI.delay(3)
		WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Bannettes vues des traitements/titLe', [('index'): "//*[@id=\"template-module\"]/div/div[3]/div[2]/div/div[1]/div[2]/div[1]/div/div/div/div/div/md-card/div[2]/button[2]/md-icon"]), FailureHandling.STOP_ON_FAILURE)
		WebUI.delay(5)
		WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Btn_Close_dialog'), 15)
		WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Btn_Close_dialog'))
		break
	}else {
