...
for (int i = 1; ; i++) {
	...
	if (Text.contains("(0)") == false) {
		...
		WebUI.delay(3)
		WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Bannettes vues des traitements/titLe', [('index'): "//*[@id=\"template-module\"]/div/div[3]/div[2]/div/div[1]/div[2]/div[1]/div/div/div/div/div/md-card/div[2]/div/div/button/md-icon"]), FailureHandling.STOP_ON_FAILURE)
		BtnClose = "//md-dialog/md-toolbar/div/button"
		WebUI.delay(5)
		WebUI.waitForElementClickable(findTestObject('Object Repository/Xpath',['index':BtnClose]), 15)
		WebUI.click(findTestObject('Object Repository/Xpath',['index':BtnClose]))
		break
	}else {
