...
for (int i = 1; ; i++) {
	...
	if (Text.contains("(0)") == false) {
		...
		WebUI.delay(3)
		WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Bttn_infos'), FailureHandling.STOP_ON_FAILURE)
		WebUI.delay(5)
		WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Btn_Close'), 15)
		WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Centre de traitement/Btn_Close'))
		break
	}else {
