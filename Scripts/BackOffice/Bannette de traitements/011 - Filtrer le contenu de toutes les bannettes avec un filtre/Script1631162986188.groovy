...
//WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Bannettes vues des traitements/btn_Gestion_Facture') , FailureHandling.STOP_ON_FAILURE)
...
for (int i = 0; i<ChoixFiltre.length ; i++) {
	switch(ChoixFiltre[i]) {
		...
		case "FAC: Date facture min" : 
		   ...
		   WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Doxtreem - Bannettes vues des traitements/titLe', [('index'): idimput]), 120, FailureHandling.STOP_ON_FAILURE)
