...
/******************************Trouver la bannette Factures à moins de 5 jours de la date d'échéance*****************************************************/
...
//for (int i = ide.toInteger(); ; i++) {
	...
	//btnFiltre = "//*[@id=\"inbox-view-" + i + "\"]/md-content/div[1]/div[1]/div[2]"
	 btnFiltre ="//label[@id='inbox-title-Factures-moins-de-5-jours-de-la-date-d-ch-ance']"
	 WebUI.delay(5)
	//if (WebUI.getAttribute(findTestObject('Object Repository/Page_Doxtreem - Bannettes vues des traitements/titLe', [('index'): aydiInbox]), 'aria-label', FailureHandling.STOP_ON_FAILURE) == "Factures à moins de 5 jours de la date d'échéance") {
