...
tablo = (WebUI.getText(findTestObject('Page_Doxtreem - Explorateur/tablo_ListDossier')).split('202'))
	 ...
	 tablo.eachWithIndex { it, i ->
		...
		WebUI.waitForElementClickable(findTestObject('Page_Doxtreem - Explorateur/dossier_cible',['num':(dossTab[0]+1)]), 120, FailureHandling.OPTIONAL)
		 ...
		 if  (WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Doxtreem - Bannettes Personnelles/Dossier_Ajouter_retirer', ['index': 10]), FailureHandling.OPTIONAL)) {
			 WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Bannettes Personnelles/Dossier_Ajouter_retirer', ['index': 10]))
			 
		 }else {
			 WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Bannettes Personnelles/Dossier_Ajouter_retirer', ['index': 11]))
		 }
		...
		WebUI.delay(1)
		CustomKeywords.'utilsFindElement.chercheElement.Selectionner'('Page_Doxtreem - Bannettes Personnelles', 'Dossier_Créer_BannettePersonnelle')
...
entet = CustomKeywords.'utils.Bannettes.ChercheIdBannette'('Personnelle_E2E')
...
button_supprimer = "//*[@id=\"" + entet + "\"]/md-content/div/div[1]/md-button-circular-progress/button/md-icon"
