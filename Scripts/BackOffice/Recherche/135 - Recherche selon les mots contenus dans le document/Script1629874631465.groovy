...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Doxtreem - Recherche/MotPstDnsContenu'), 3)

WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Recherche/Champ_Mot_prsnt'))

WebUI.sendKeys(findTestObject('Object Repository/Page_Doxtreem - Recherche/Champ_Mot_prsnt'), Keys.chord('B','l','e','u'), FailureHandling.STOP_ON_FAILURE)
