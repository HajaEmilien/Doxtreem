...
//TestObject MyTestObject1 = findTestObject('Object Repository/Page_Doxtreem - Recherche/Type_document')
//claie = WebUI.getAttribute(MyTestObject1, "for")

WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Recherche/Type_document'))
//WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Recherche/Click_Type_document',['aid':claie]))

WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Recherche/Click_liste_item'))
...
assertTrue(WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Doxtreem - Recherche/affichage_resultat'), FailureHandling.STOP_ON_FAILURE))
if (WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Doxtreem - Recherche/bouton_plus'), FailureHandling.OPTIONAL)) {
	WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Recherche/bouton_plus'))
	println('Bouton plus cliqué')
