...
/********************Création d'un document et ajout identifiant du doc dans globalvariable identifiant**************************************/
...
WebUI.callTestCase(findTestCase('Tools/Suppression recherche sauvegardée'), ['varNom':nomSearch], FailureHandling.STOP_ON_FAILURE)
