...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Doxtreem - Explorateur/button_Voir les favoris'), 10, FailureHandling.STOP_ON_FAILURE)
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Doxtreem - Explorateur/button_Voir les favoris'), 10, FailureHandling.STOP_ON_FAILURE)
...
WebUI.delay(5)
WebUI.waitForElementPresent(findTestObject('Page_Doxtreem - Explorateur/button_download_zip'), 200, FailureHandling.STOP_ON_FAILURE)
