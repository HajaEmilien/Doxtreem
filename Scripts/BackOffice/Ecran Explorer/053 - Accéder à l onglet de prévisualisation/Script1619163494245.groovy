...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Doxtreem - Explorateur/onglet_Previsualisation'), 120)

WebUI.click(findTestObject('Object Repository/Page_Doxtreem - Explorateur/onglet_Previsualisation'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Doxtreem - Explorateur/pdf_viewer'), 120)
