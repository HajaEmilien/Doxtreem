...
/*Verification du boutton favoris n'est plus cliquable */
/*//WebUI.delay(2)
assertTrue(WebUI.verifyElementNotClickable(findTestObject('Page_Doxtreem - Explorateur/favoriteButton')))*/
