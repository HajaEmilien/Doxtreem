...
assertTrue(WebUI.verifyElementText(findTestObject('Page_Doxtreem - Plan de classement modle/span_Gestion du plan de classement modle'), 'Gestion du plan de classement modèle'))
